...
const Layout = () => {
  ...
  return (
    <div className="min-h-screen bg-[#030816] text-slate-100 font-sans flex overflow-x-hidden">
      {/* Dynamic Background */}
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-cyan-500/10 rounded-full blur-[100px]" />
        <div className="absolute bottom-[-10%] right-[-10%] w-[60%] h-[60%] bg-fuchsia-500/10 rounded-full blur-[120px]" />
      </div>
      ...
      <div className="flex-1 flex flex-col min-w-0 relative z-10">
        ...
        <header className="sticky top-0 z-40 w-full bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200/50 dark:border-slate-800/50 md:hidden">
          <div className="flex h-16 items-center justify-between px-4">
            <div className="flex items-center gap-2">
              ...
              <h1 className="text-xl font-bold bg-gradient-to-r from-cyan-300 via-white to-fuchsia-300 bg-clip-text text-transparent">
                EduPulse AI
              </h1>
            </div>
        ...
        {/* Main Content Area */}
        <main className="flex-1 w-full p-0 pb-20 md:pb-0">
          <Outlet />
        </main>
